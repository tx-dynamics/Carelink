  ...
  return (
    <AppGLobalView style={styles.container}>
      <View style={styles.DirectionView}>
        <Header
          headerLabel={'Side Menu'}
          onPressLeft={() => navigation.dispatch(DrawerActions.toggleDrawer())}
          leftImgStyle={styles.leftIconStyle}
          leftImgName={require('../../../assets/cross.png')}
        />
        <View style={{}}>
          {/* Single Item */}
          <TouchableOpacity
          ...
          <TouchableOpacity
            onPress={() =>
              navigation.navigate('withoutBottomTabnavigator', {screen: 'Help'})
            }
            style={styles.items}>
      ...
      <TouchableOpacity
        ...
        onPress={() =>
          navigation.navigate('withoutBottomTabnavigator', {
            screen: routes.deleteAccountPassword,
          })
        }>
