  ...
  return (
    <StackNavigator.Navigator
      ...
      <StackNavigator.Screen
        name={routes.roomProposal}
        component={RoomsProposals}
      />
      <StackNavigator.Screen
      ...
      <StackNavigator.Screen
        name={routes.createContract}
        component={StartContract}
      />
      <StackNavigator.Screen
        name={routes.activeContracts}
      ...
      <StackNavigator.Screen
        ...
        component={BookedRoomsAgencySide}
      />
      <StackNavigator.Screen
        name={routes.bookedRoomDetailAgency}
        component={BookedRoomDetailAgency}
      />
      <StackNavigator.Screen
        name={routes.agencyProposalList}
        component={AgencyProposalList}
      />
      <StackNavigator.Screen
        name={routes.availableRoom}
        component={AvailableRoom}
      />
      <StackNavigator.Screen
        name={routes.inactiveRoom}
        component={InactiveRoom}
      />
      <StackNavigator.Screen
      ...
      <StackNavigator.Screen
        name={routes.inactiveList}
        component={InactiveList}
      />
      <StackNavigator.Screen
        name={routes.userCertificateList}
        component={CertifcateScreen}
      />
      <StackNavigator.Screen
      ...
      />
      <StackNavigator.Screen
        name={routes.deleteAccountPassword}
        component={DeleteAccountPassword}
      />
      <StackNavigator.Screen
        name={routes.deleteAccountOTP}
...
const AppNavigator = () => {
  return (
    <StackNavigator.Navigator>
      ...
      <StackNavigator.Screen
        name="withoutBottomTabnavigator"
...
const ProfileNavigator = () => {
  ...
  return (
    <StackNavigator.Navigator screenOptions={{headerShown: false}}>
      {usertype === 'ServiceSide' ? (
        <StackNavigator.Screen
          name="ServiceClientProfile"
          component={ServiceClientProfile}
        />
      ) : (
        ...
        options={{
          tabBarIcon: ({focused}) =>
            focused ? (
              <View
                style={
                  usertype === 'ServiceSide' ? styles.scBox1 : styles.tabBox1
                }>
                <Image
              ...
              <View
                style={
                  usertype === 'ServiceSide' ? styles.scBox : styles.tabBox
                }>
                <Image
