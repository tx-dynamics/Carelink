    ...
    <AppGLobalView style={styles.container}>
      ...
      <KeyboardAwareScrollView showsVerticalScrollIndicator={false}>
        <ServiceProviderInfo
          ...
          note={
            'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ac vel in ipsum duis suspendisse. Ut urna, tristique magnis mauris, volutpat purus'
          }
        />
      </KeyboardAwareScrollView>
      <FormButton onPress={onPressInactive} buttonTitle={'Inactive'} />
      <DeleteModal
        title={'Are you sure you want to inactive the room?'}
        rightButtonTitle={'Inactive'}
        visible={visible}
