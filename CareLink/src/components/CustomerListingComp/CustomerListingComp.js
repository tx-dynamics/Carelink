...
const CustomerListingComp = ({ onPress, title, rightIcon, rightPress, rightDisable, duration, facilityData, posted }) => {
    return (
        <Pressable onPress={onPress} style={styles.container}>
            <View style={styles.subView}>
                <Text style={styles.titleText}>{title}</Text>
                {rightIcon && <TouchableOpacity disabled={rightDisable} onPress={rightPress}>
