...
const SelectBox = ({ count, leftTitle, myStl,
    circle = false, description, isDesc = false, rightText, forward,
    ...
    return (
        ...
        >
            <View style={styles.DirectionView}>
                ...
                {rightText === false && <Apptext style={styles.underLine}>
                    {rightText}
                </Apptext>}
                {forward && <Image resizeMode='contain' source={appIcons.forward} style={{
                    width: widthPixel(24),
