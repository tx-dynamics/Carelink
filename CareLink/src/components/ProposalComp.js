...
const ProposalComp = ({
  ...
  name,
  location,
  rightImg = require('../../assets/heart.png'),
  onPress,
  borderRadius = 10,
  rightOnPress,
  description,
  ...
  return (
    <TouchableOpacity
      ...
      <View style={styles.direcView}>
        <View>
          <Image style={styles.imgView} source={{uri: image}} />
        </View>
        <View>
          ...
          <Apptext numberOfLines={1} style={styles.descTxt}>
            Received: <TimeAgoComponent date={description} />
